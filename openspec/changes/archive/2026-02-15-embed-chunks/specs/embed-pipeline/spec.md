...
### Requirement: EmbedBookUseCase orchestrates chunk embedding
...
### Requirement: Chunks are embedded in batches
...
### Requirement: Existing embeddings are replaced on re-embed
...
### Requirement: Embedding failure does not corrupt book state
...
### Requirement: CLI embed command wires the pipeline
