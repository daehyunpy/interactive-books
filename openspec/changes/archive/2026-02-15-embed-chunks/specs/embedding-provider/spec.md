...
### Requirement: EmbeddingProvider protocol defines embedding generation contract
...
### Requirement: EmbeddingVector value object represents a chunk's vector
...
### Requirement: OpenAI embedding adapter implements EmbeddingProvider
...
### Requirement: Provider exposes metadata
