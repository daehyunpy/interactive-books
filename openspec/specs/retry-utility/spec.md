...
Shared infrastructure utility for retrying callables on transient errors with exponential backoff and jitter. Reusable by any adapter that calls external APIs with rate limits.

## Requirements

### RU-1: Shared retry utility with exponential backoff
